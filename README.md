...
<td valign="top" width="40%" align="center">
 ...
 | **🎨 DemoniDraw** |
 | :--- |
 | **Android · Automation · Accessibility**<br>Gesture commands, recognition and programmable automation.<br><br>`Kotlin` `Gestures` `Macros` `Overlay`<br><br>[![](https://img.shields.io/badge/VIEW_REPOSITORY-007ACC?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Jaypsmall/DemoniDraw) |
 
 
 | **🔓 HexRootScan** |
 | :--- |
 | **Android · Pentesting · Network**<br>Network reconnaissance and security toolkit for Android mobiles.<br><br>`Kotlin` `Nmap` `DNS` `Whois`<br><br>[![](https://img.shields.io/badge/VIEW_REPOSITORY-007ACC?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Jaypsmall/HexRootScan) |
...
<td valign="top" width="40%" align="center">
 ...
 | **👁️ DaltonicAssist** |
 | :--- |
 | **Android · Accessibility · Vision**<br>Accessibility-oriented visual assistance color perception tools.<br><br>`Kotlin` `Accessibility` `Vision`<br><br>[![](https://img.shields.io/badge/VIEW_REPOSITORY-007ACC?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Jaypsmall/DaltonicAssist) |
